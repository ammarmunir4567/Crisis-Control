...
public class DonorPaymentActivity extends AppCompatActivity {

    private  String postData = "";
    private WebView mWebView;

    private final String Jazz_MerchantID      = "MC51332";
    private final String Jazz_Password        = "xy881d32du";
    private final String Jazz_IntegritySalt   = "5s0x2g8421";

    private static final String paymentReturnUrl="http://localhost/donation.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView = (WebView) findViewById(R.id.jazzCashWebView);
        // Enable Javascript
        ...
        String price = intentData.getStringExtra("Amount");
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(DonorPaymentActivity.this, DonationPostActivity.class);
